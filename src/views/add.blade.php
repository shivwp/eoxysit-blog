...
<div class="col-8 ">Add Blog</div>
    ...
    <div class="form-group">
      <div class="col-8">
         ...
         <select class="browser-default custom-select" name="subcategory" id="subcategory"></select>
     </div>
    </div>
    ...
    <input type="text" name="authername" class="form-control" placeholder="Enter Auther Name" required>
    </div>
    </div>
    <div class="form-group">
    <div class="col-8">
